...
if(DEFINED SKYWALKING_PROTOCOL_PATH)
    set(PROTOC_BASE_DIR "${SKYWALKING_PROTOCOL_PATH}")
else()
    message(FATAL_ERROR "skywalking-data-collect-protocol not configured. Initialize submodules (git submodule update --init --recursive), set -DSKYWALKING_PROTOCOL_PATH=/path/to/skywalking-data-collect-protocol, or enable SKYWALKING_FETCHCONTENT in CMake.")
endif()
